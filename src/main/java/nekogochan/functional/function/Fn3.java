...
public interface Fn3<T1, T2, T3, R> {
  ...
  default Fn2<T1, T2, R> $$(T3 t3) {
    return (t1, t2) -> this.apply(t1, t2, t3);
  }

  default Fn1<T1, R> $$(T2 t2, T3 t3) {
    return (t1) -> this.apply(t1, t2, t3);
  }

  default Fn0<R> $$(T1 t1, T2 t2, T3 t3) {
    return () -> this.apply(t1, t2, t3);
  }

  default Fn0<R> __(T1 t1, T2 t2, T3 t3) {
    return () -> this.apply(t1, t2, t3);
  }

  default Fn1<T3, R> __(T1 t1, T2 t2) {
    return (t3) -> this.apply(t1, t2, t3);
  }

  default Fn2<T2, T3, R> __(T1 t1) {
